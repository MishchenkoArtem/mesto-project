...
export const popupPictureCaption = popupImage.querySelector(
    '.popup__title-image'
)
...
export const formProfileSelector = document.forms.formProfile
...
export const formCardSelector = document.forms.formCard
export const cardName = document.forms.formCard.cardName
export const cardImage = document.forms.formCard.cardImage
export const formAvatarSelector = document.forms.formAvatar
